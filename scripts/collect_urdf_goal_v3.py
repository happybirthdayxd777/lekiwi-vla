#!/usr/bin/env python3
"""
Phase 108: Goal-Aware Data Collection for k_omni Physics
=======================================================
KEY INSIGHT from Phase 107 analysis:
  M7=[0,1,-1] produces +X PURE forward motion (2.65m in X, 0.19m in Y = 97% forward)
  M9=[0.5,0.5,-0.5] produces +X+0.9Y diagonal (38.7deg from X)
  M6=[2,1,0] produces +X+0.95Y diagonal (43.4deg from X)
  M2=[1,1,1] produces minimal motion
  M3=[0.5,-0.5,0] produces pure rotation (no translation)
...
Usage:
  python3 scripts/collect_urdf_goal_v3.py --episodes 200 --output data/phase108_urdf_goal_v3.h5
"""
...
def collect_episode(sim, controller, max_steps=200, goal_min=0.3, goal_max=0.7,
...
def main():
    ...
    print(f"[INFO] Phase 108: Goal-Aware Data Collection for k_omni Physics")
    print(f"[INFO] Using GoalAwareController (Phase 107 empirical k_omni force mapping)")
    ...
    controller = GoalAwareController(steps_per_move=20, exploration_noise=0.1)
