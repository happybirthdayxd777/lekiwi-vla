...
def generate_xml() -> str:
    ...
    lines = [
        ...
        '    <mesh file="meshes/4-Omni-Directional-Wheel_Single_Body-v1-1.stl" name="omni_wheel_1"/>',
        '    <mesh file="meshes/4-Omni-Directional-Wheel_Single_Body-v1-2.stl" name="omni_wheel_2"/>',
        '    <mesh file="meshes/4-Omni-Directional-Wheel_Single_Body-v1.stl" name="omni_wheel_3"/>',
